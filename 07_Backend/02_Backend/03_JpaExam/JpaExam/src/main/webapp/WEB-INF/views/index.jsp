...
<div class="container">
    ...
    <%--  jsp 범위 (scope) 객체 : 변수의 사용 범위를 정하는 객체
          ...
          변수 저장소(사용 범위 : scope) :
              page(현재 페이지) < request(모든 페이지) < session(모든 페이지) < application(전체 프로그램) --%>
    <%--  TODO: 사용법 : <c:set var="변수명" value="값" scope="jsp 객체"/> --%>
    ...
    <%--  if문(조건문)과 함께 사용  --%>
    <%--  TODO: 사용법 : <c:redirect url="이동 url"/>  --%>
