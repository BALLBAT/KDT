 ...
 * description :
 * 요약 :
 * TODO: @Controller : 클래스에 컨트롤러 기능 부여하는 어노테이션
...
// TODO: Model 구조 : (키, 값) 형태로 되어있고(해쉬맵구조) 키를 jsp 로 전송할 수 있음
//      사용법 : mode.addAttribute("키이름(변수명)", "값");
...
//                      "수고해!!!"
    ...
    public String Hello2(Model model) {
        model.addAttribute("g", "안녕 hello2 페이지");
        model.addAttribute("g2", "springboot2 처음이지");
        model.addAttribute("g3", "수고해!!!");
...
//  뷰/html 코딩 : 자동정렬 ctrl + alt + l (인텔리제이 단축키)
    ...
    public String Hello3 (Model model) {
        model.addAttribute("g", "안녕 JSP 페이지야");
        model.addAttribute("g2", "JSP 에는 JSTL");
        model.addAttribute("g3", "EL 표현식이 있습니다.");
...
//      TODO: 기초 디버깅 : sout
//      밑에 찍어보고 재시작한 다음에 휴지통으로 실행명령문들 지우고 출력 페이지 새로고침
