...
--         첫글자 대문지 변환 : INITCAP('문자열') 또는 INITCAP(컬럼명)
...
SELECT 'Oracle', 'mania', CONCAT('Oracle', 'mania') AS 함수,
        'Oracle' || 'mania' AS 예약어
        FROM DUAL;
...
-- 1-7) 문자열의 양옆의 공백 제거하기 함수 : LTRIM, RTRIM, TRIM
-- 사용법 : 
SELECT 'Oracle mania'
    , LTRIM('  Oracle mania  ')
    , RTRIM('  Oracle mania  ')
